    ...
    <div>
        <div class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList ID="Origen" runat="server" Width="200px" BackColor="#ECEFF1" CssClass="btn-default">
            ...
            <div class="form-group">
                ...
                <div class="col-md-10">
                    <asp:DropDownList ID="Destino" runat="server" Width="200px" BackColor="#ECEFF1" CssClass="btn-default">
                        <asp:ListItem Text="Seleccione" Value="0" Selected="True"></asp:ListItem>
                        <asp:ListItem Text="Quito" Value="Quito"></asp:ListItem>
                        <asp:ListItem Text="Guayaquil" Value="Guayaquil"></asp:ListItem>
                        <asp:ListItem Text="Cuenca" Value="Cuenca"></asp:ListItem>
            ...
            <table runat="server">
                <tr>
                    <td>
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Salida" CssClass="col-md-2 control-label">Fecha Salida</asp:Label>
                            <div class="col-md-10">
                                <asp:Calendar ID="Salida" runat="server" OnSelectionChanged="Calendar1_SelectionChanged"></asp:Calendar>
                            </div>
                        </div>
                    </td>
                    <td>
                        <div class="form-group">
                            <asp:Label runat="server" AssociatedControlID="Llegada" CssClass="col-md-2 control-label">Fecha Llegada</asp:Label>
                            <div class="col-md-10">
                                <asp:Calendar ID="Llegada" runat="server" OnSelectionChanged="Calendar1_SelectionChanged"></asp:Calendar>
                            </div>
                        </div>
                    </td>
                </tr>
            ...
            <div class="form-group">
                <asp:Label runat="server" AssociatedControlID="Capacidad" CssClass="col-md-2 control-label">Capacidad Asientos</asp:Label>
                <div class="col-md-10">
                    <asp:TextBox runat="server" ID="Capacidad" CssClass="form-control" />
                </div>
            </div>
            <div class="form-group">
