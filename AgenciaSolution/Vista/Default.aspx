...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        <div class="row">
            <div class="col-md-12">
                <h1 class="text-primary">Traveling Fast   <small>Agencia de Vuelos<span class="glyphicon glyphicon-send" aria-hidden="true"></span></small></h1>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <p>
                Puede separar sus vuelos mediante fechas y considerando los menores precios, se asegura también la posibilidad de manejar tipos de asientos.
            </p>
            <p>
                <a class="btn btn-primary" href="Account/Login">Comenzar &raquo;</a>
            </p>
        ...
        <div class="col-md-4">
            ...
            <p>
                Registrese en nuestra plataforma y sea parte de una gran compañía que ofrece y garantiza a usted los mejores servicios de reservación de vuelos.
            </p>
            <p>
                <a class="btn btn-primary" href="Account/Login">Comenzar &raquo;</a>
            </p>
